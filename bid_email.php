<?
	...
	list($l_name,$l_address,$l_city,$l_state,$l_zipcode,$l_phone,$l_email,$c_contact_name,$c_business_name,$c_address,$c_city,$c_state,$c_zipcode,$c_phone,$p_address,$p_city,$p_state,$p_zipcode,$s_name) = mysqli_fetch_row($sqlA);
?>
