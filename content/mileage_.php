                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="background: url('imgs/input_column.jpg') no-repeat; width: 470px; height: 36th; vertical-align: middle; color: #000000; padding: 0px 0px 0px 0px; font-size: 11px; font-family: Tahoma, Arial, sans-serif; text-align: left;">
                                                                <div style="padding-left: 15px;">
                                                                    <input type="text" name="drive_date" value="<?= isset($drive_date) ? $drive_date : "" ?>" style="width: 70px; height: 14px; background: inherit; color: #000000; font-size: 11px; font-family: Tahoma, Arial, sans-serif; border: 0px;">
                                                                </div>
                                                            </td>
...
<?
	...
	$sql_e = mysqli_query($connection ,$sql_e);
	while(list($vid,$v_year,$v_make,$v_model,$v_submodel,$v_engine,$v_notes) = mysqli_fetch_row($sql_e)) {
?>
								                                        <option value="<?= $vid ?>" <? if(isset($vehicle_id) && $vehicle_id == $vid) echo("selected"); ?>><?= $v_year.' '.$v_make.' '.$v_model.' - '.$v_submodel ?></option>
<?
	}
?>
    							                                     </select>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="background: url('imgs/input_column.jpg') no-repeat; width: 470px; height: 36th; vertical-align: middle; color: #000000; padding: 0px 0px 0px 0px; font-size: 11px; font-family: Tahoma, Arial, sans-serif; text-align: left;">
                                                                <div style="padding-left: 15px;">
                                                                    <input type="text" name="start_miles" value="<?= isset($start_miles) ? $start_miles : 0 ?>" style="width: 250px; height: 14px; background: inherit; color: #000000; font-size: 11px; font-family: Tahoma, Arial, sans-serif; border: 0px;">
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td style="background: url('imgs/input_column.jpg') no-repeat; width: 470px; height: 36th; vertical-align: middle; color: #000000; padding: 0px 0px 0px 0px; font-size: 11px; font-family: Tahoma, Arial, sans-serif; text-align: left;">
                                                                <div style="padding-left: 15px;">
                                                                    <input type="text" name="end_miles" value="<?= isset($end_miles) ? $end_miles : 0 ?>" style="width: 250px; height: 14px; background: inherit; color: #000000; font-size: 11px; font-family: Tahoma, Arial, sans-serif; border: 0px;">
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td style="background: url('imgs/input_column.jpg') no-repeat; width: 470px; height: 36th; vertical-align: middle; color: #000000; padding: 0px 0px 0px 0px; font-size: 11px; font-family: Tahoma, Arial, sans-serif; text-align: left;">
                                                                <div style="padding-left: 15px;">
                                                                    <input type="text" name="subttl" value="<?= isset($subttl) ? $subttl : 0 ?>" style="width: 250px; height: 14px; background: inherit; color: #000000; font-size: 11px; font-family: Tahoma, Arial, sans-serif; border: 0px;">
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td style="background: url('imgs/input_column.jpg') no-repeat; width: 470px; height: 36th; vertical-align: middle; color: #000000; padding: 0px 0px 0px 0px; font-size: 11px; font-family: Tahoma, Arial, sans-serif; text-align: left;">
                                                                <div style="padding-left: 15px;">
                                                                    <input type="text" name="notes" value="<?= isset($notes) ? $notes : "" ?>" style="width: 350px; height: 14px; background: inherit; color: #000000; font-size: 11px; font-family: Tahoma, Arial, sans-serif; border: 0px;">
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
...
<?
	...
	while(list($inv_id, $inv_address, $inv_city, $inv_state, $inv_zipcode, $inv_sku) = mysqli_fetch_row($sql_d)) {
...
?>
								                                        <option value="<?= $inv_id ?>" <? if(isset($invoice) && $inv_id == $invoice) echo("selected"); ?>><?= $inv_id.' - '.$inv_projectsite.' ('.$inv_sku.')' ?></option>
<?
	}
?>
    							                                     </select>
...
<?
	...
	while(list($inv_idB, $inv_addressB, $inv_cityB, $inv_stateB, $inv_zipcodeB, $inv_skuB) = mysqli_fetch_row($sql_f)) {
...
?>
								                                        <option value="<?= $inv_idB ?>" <? if(isset($invoice_2) && $inv_idB == $invoice_2) echo("selected"); ?>><?= $inv_idB.' - '.$inv_projectsiteB.' ('.$inv_skuB.')' ?></option>
<?
	}
?>
    							                                     </select>
...
<?
	...
	$sql_g = mysqli_query($connection ,$sql_g);
	while(list($inv_idC, $inv_addressC, $inv_cityC, $inv_stateC, $inv_zipcodeC, $inv_skuC) = mysqli_fetch_row($sql_g)) {
...
?>
								                                        <option value="<?= $inv_idC ?>" <? if(isset($invoice_3) && $inv_idC == $invoice_3) echo("selected"); ?>><?= $inv_idC.' - '.$inv_projectsiteC.' ('.$inv_skuC.')' ?></option>
<?
	}
?>
    							                                     </select>
